...
impl<'s, 't> SaDiff<'s, 't> {
    ...
    pub fn new(
        ...
        SaDiff { s, t, sa, small_match, mismatch_count, long_suffix, i0: 0, j0: 0, n0: 0, b0: 0 }
    }

    #[inline]
    fn previous_state(&self) -> (usize, usize, usize, usize) { (self.i0, self.j0, self.n0, self.b0) }
