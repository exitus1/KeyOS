...
use {
    crate::{
        ...
        export_account::{vault_format, WalletConnector},
...
impl WalletConnector for Connector {
    ...
    fn formats(&self) -> ExportFormats { ExportFormats { visual: VisualFormat::QR, file: true } }

    fn file_extension(&self, _as_multi: bool) -> String { String::from("json") }

    fn display_name(&self) -> SharedString { SharedString::from("BTCPay") }
