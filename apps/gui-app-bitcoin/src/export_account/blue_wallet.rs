...
use {
    crate::{
        ...
        export_account::{electrum_format, generic_multi_format, WalletConnector},
...
impl WalletConnector for Connector {
    ...
    fn display_name(&self) -> SharedString { SharedString::from("BlueWallet") }
    ...
    fn connect(
        ...
        match as_multi {
            false => electrum_format(id, cfg, false),
