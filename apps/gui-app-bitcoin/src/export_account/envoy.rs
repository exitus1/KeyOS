...
impl WalletConnector for Connector {
    ...
    fn formats(&self) -> ExportFormats { ExportFormats { visual: VisualFormat::UR2, file: false } }

    fn file_extension(&self, _as_multi: bool) -> String { String::new() }

    fn display_name(&self) -> SharedString { SharedString::from("Envoy") }
